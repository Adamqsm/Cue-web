  ...
  return (
    <>
      ...
      <section className="container-pad pb-24">
        <div className="mx-auto grid max-w-4xl gap-10 rounded-[2rem] border border-ink/10 bg-paper-soft/60 p-8 sm:p-12 md:grid-cols-[0.9fr_1.1fr]">
          <div>
            <span className="eyebrow">{f.contact.kicker}</span>
            <h2 className="mt-3 text-3xl font-semibold text-ink sm:text-4xl">
              {f.contact.title}
            </h2>
            <p className="mt-3 text-ink/70">{f.contact.body}</p>
          </div>
